...
class CiviCRM_Caldera_Forms_Order_Processor {
	...
	public function add_payment_processor_hooks( $form, $referrer, $process_id ) {
		...
		// authorize single
		if ( Caldera_Forms::get_processor_by_type( 'auth-net-single', $form ) && ( Caldera_Forms_Field_Util::has_field_type( 'civicrm_country', $form ) || Caldera_Forms_Field_Util::has_field_type( 'civicrm_state', $form ) ) || Caldera_Forms::get_processor_by_type( 'auth-net-rec', $form ) && ( Caldera_Forms_Field_Util::has_field_type( 'civicrm_country', $form ) || Caldera_Forms_Field_Util::has_field_type( 'civicrm_state', $form ) ) ) {
			/**
